            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="movie.releaseDate.label" default="Release Date" /></td>
                            
                            <td valign="top" class="value"><g:formatDate date="${movieInstance?.releaseDate}" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="movie.lastUpdated.label" default="Last Updated" /></td>
                            
                            <td valign="top" class="value"><g:formatDate date="${movieInstance?.lastUpdated}" /></td>
