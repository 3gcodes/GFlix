    ...
    def init = { servletContext ->
		environments {
			development {
				...
				new Movie(title:"The Karate Kid", description: "Daniel kicks Johnny's ass", releaseDate:new Date().parse(dateFormat, '1984-06-22')).save(flush:true)
				new Movie(title:"The Karate Kid, Part II", description: "Daniel kicks Chozen's ass", releaseDate:new Date().parse(dateFormat, '1986-06-20')).save(flush:true)
				new Movie(title:"The Karate Kid, Part III", description: "Daniel kicks Terry's ass", releaseDate:new Date().parse(dateFormat, '1989-06-30')).save(flush:true)
